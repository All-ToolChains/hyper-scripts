...
TC_PATH=$DIR/out/${TOOLCHAIN1}-X-${TOOLCHAIN2}-aarch64-linux-android-6.x
...
then
    ...
    echo "${bldgrn}_|_|_|      _|_|      _|_|_|    _|_|_|  _|_|_|_|  _|_|_|    _|_|_|    _|${txtrst}"
    echo ""
    echo "${bldgrn}Your ${TOOLCHAIN1}-X-${TOOLCHAIN2} 6.x aarch64-linux-android-6.x Toolchain has compiled successfully! ${txtrst}"
