...
CPU=$3
FPU=$4
if [ "$TOOLCHAIN1" = "Uber" ]; then
DISABLES="--disable-libgomp"
fi;
...
TC_PATH=$DIR/out/$TOOLCHAIN1-X-$TOOLCHAIN2-arm-linux-androideabi-5.x
...
GCC_INSTALLED=$TC_PATH/bin/arm-linux-androideabi-gcc;
if [ -e $GCC_INSTALLED ];
then
    ...
    echo "${bldgrn}_|_|_|      _|_|      _|_|_|    _|_|_|  _|_|_|_|  _|_|_|    _|_|_|    _|${txtrst}"
    echo ""
    echo "${bldgrn}Your $TOOLCHAIN1-X-$TOOLCHAIN2 5.x arm-linux-androideabi Toolchain has compiled successfully! ${txtrst}"
