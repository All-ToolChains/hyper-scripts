...
cd $OUT/$dir;
git init && git add -A && git commit -m "New Build" -s && git checkout -b $branch && git push https://bitbucket.org/hyper-toolchains/arm-eabi-4.9 $branch;
done;
...
cd $OUT/$dir;
git init && git add -A && git commit -m "New Build" -s && git checkout -b $branch && git push https://bitbucket.org/hyper-toolchains/arm-eabi-5.x $branch;
done;
...
cd $OUT/$dir;
git init && git add -A && git commit -m "New Build" -s && git checkout -b $branch && git push https://bitbucket.org/hyper-toolchains/arm-eabi-6.x $branch;
done;
...
cd $OUT/$dir;
git init && git add -A && git commit -m "New Build" -s && git checkout -b $branch && git push https://bitbucket.org/hyper-toolchains/arm-eabi-7.x $branch;
done;
...
cd $OUT/$dir;
git init && git add -A && git commit -m "New Build" -s && git checkout -b $branch && git push https://bitbucket.org/hyper-toolchains/arm-linux-androideabi-4.9 $branch;
done;
...
cd $OUT/$dir;
git init && git add -A && git commit -m "New Build" -s && git checkout -b $branch && git push https://bitbucket.org/hyper-toolchains/arm-linux-androideabi-5.x $branch;
done;
