...
TC_PATH=$DIR/out/${TOOLCHAIN1}-X-${TOOLCHAIN2}-arm-eabi-7.x
...
# Android sysroot
SYSROOT_SRC_PATH=../sysroot/7.x/arch-arm;
...
then
    ...
    echo "${bldgrn}_|_|_|      _|_|      _|_|_|    _|_|_|  _|_|_|_|  _|_|_|    _|_|_|    _|${txtrst}"
    echo ""
    echo "${bldgrn}Your ${TOOLCHAIN1}-X-${TOOLCHAIN2} 7.x arm-eabi Toolchain has compiled successfully! ${txtrst}"
